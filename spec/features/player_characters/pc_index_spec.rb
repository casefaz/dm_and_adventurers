...
RSpec.describe 'adventurer index', type: :feature do
    it 'can present each adventurer with its attributes' do
        ...
        adventurer = PlayerCharacter.create!(player_name: 'karl', character_name: 'Onion', character_level: 7,character_age: 207, character_class: 'Bard', character_race: 'Dwarf', is_alive: true)
