...
RSpec.describe PlayerCharacter, type: :model do
    ...
    describe 'class methods' do 
        ...
        it 'can .filter_by(params)' do 
            ...
            expect(PlayerCharacter.filter_by({sort: true})).to eq([adventurer_2, adventurer1, adventurer3, adventurer_3, adventurer, adventurer2])
            expect(PlayerCharacter.filter_by({threshold: 7})).to eq([adventurer_2, adventurer_3, adventurer1, adventurer2])
            # expect(PlayerCharacter.filter_by({sort: true, threshold: 7})).to eq([adventurer_2, adventurer1,adventurer_3, adventurer2])
            expect(PlayerCharacter.filter_by({sort: nil})).to eq([adventurer, adventurer_2, adventurer_3, adventurer1, adventurer2, adventurer3])
        end
    end
end